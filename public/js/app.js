...
if ($registration) {
  var sendForm = function sendForm(e) {
    e.preventDefault();
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/registration', new FormData($registration)).then(function (e) {
  ...
  var $fieldName = $registration.querySelectorAll('input[name="login"]');
