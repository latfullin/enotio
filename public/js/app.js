...
var $registration = document.querySelector('.form-registration');
if ($registration) {
  var passwordField = [];
  var sendForm = function sendForm(e) {
    e.preventDefault();
    var result = axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/registration', new FormData($registration)).then(function (e) {
  ...
  var $fieldName = $registration.querySelector('input[name="login"]');
  $fieldName.addEventListener('input', function () {
    return checkLength($fieldName);
  });
  var $fieldPassword = $registration.querySelectorAll('input[type="password"]');
  var checkPassword = function checkPassword(field) {
    checkLength(field);
    checkDoublePassword();
  };
  var checkDoublePassword = function checkDoublePassword() {};
  $fieldPassword.forEach(function (field) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/authorization', new FormData(formAuth));
          case 3:
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkenotio"] = self["webpackChunkenotio"] || [];
