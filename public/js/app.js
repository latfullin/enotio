...
if ($registration) {
  ...
  var sendForm = function sendForm(e) {
    e.preventDefault();
    var result = axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/registration', new FormData($registration)).then(function (e) {
